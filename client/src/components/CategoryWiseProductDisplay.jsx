  ...
  return (
    <div>
         <div className='container mx-auto p-4 flex items-center justify-between'>
                ...
                <div className='flex items-center gap-4 p-4 md:gap-6  lg:gap-8 container mx-auto'>
                    { loading && 
                    ...
                    <div className='w-full left-0 right-0 container mx-auto absolute hidden lg:flex px-2 justify-between'>
                        <button className='z-10 relative bg-white shadow-lg p-4 cursor-pointer hover:bg-gray-100 rounded-full text-lg'>
                                <FaAngleLeft/>
                        </button>
                        <button className='z-10 relative bg-white shadow-lg p-4 cursor-pointer hover:bg-gray-100 rounded-full text-lg'>
                                <FaAngleRight/>
